...
DEFAULT_INPUT = Path(BASE_DIR) / "aichatbot" / "eval" / "CluboraX_Evaluation_v2.xlsx"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    default_out = Path(BASE_DIR) / "aichatbot" / "eval" / "reports" / f"eval_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
