...
- `Club_QA.txt`
- `Others_QA.txt`
- `Rules_QA.txt` (fully integrated into the embedding pipeline)
...
1) Edit `aichatbot/Event_QA.txt`, `Club_QA.txt`, `Others_QA.txt`, or `Rules_QA.txt`
...
Note: `Rules_QA.txt` is fully integrated and supported out of the box.
