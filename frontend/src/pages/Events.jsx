...
// STRIPE INTEGRATION GUIDELINE ” Connect when backend is ready
...
// 4. Backend (Django) ” create these endpoints:


//      POST /api/payments/create-intent/


//        ’ receives { event_id, amount, user_id }


//        ’ calls stripe.PaymentIntent.create(amount=..., currency='usd', metadata={...})
...
//        ’ receives { paymentIntentId, ticketData }


//        ’ verifies status == 'succeeded' via Stripe API


//        ’ saves PaymentRecord (invoice_id, student_id, event_id, amount, timestamp, status)


//        ’ activates registration, generates QR ticket
...
//        ’ validate with stripe.WebhookSignature.verify()
...
//      Proof upload ’ stored in Django (FileField / S3)


//      Finance admin reviews via admin panel (proposal_management style)


//      PUT /api/payments/<id>/verify/ ’ { status: 'approved'|'rejected', reason }
...
const Events = () => {
  ...
  // Create Event functionality disabled for MVP
  ...
  const handleCreateEventSubmit = useCallback(async (options = {}) => {
    ...
    try {
      ...
      const payload = {
        ...
        event_type: eventForm.eventType || 'general',


        max_participants: parseInt(eventForm.maxAttendees) || null,


        is_paid: parseFloat(eventForm.price) > 0,
        ...
        contact_phone: eventForm.phoneNumber,
      ...
      if (showSuccessToast) {
        ...
        if (platformFee > 0) {
          ...
          toast.success(`Event created! Platform fee: $${platformFee.toFixed(2)}`)
  ...
  }, [eventForm, calculatePlatformFee, user, queryClient])
  ...
  const { data: eventsRaw = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return raw.map(e => {
        ...
        // Filter out invalid image URLs (file://, null, empty string, etc.)
  ...
  const events = eventsRaw.filter(e => e.endDt && e.endDt >= now)
  ...
  // ””” ABA PayWay QR: create order ’ go to qr_scanning step ””””””””””””””
  ...
  const handleStartAbaQr = useCallback(() => {
    ...
    // ”‚  HOW IT WORKS (the magic behind "scan ’ auto complete"):            ”‚


    // ”‚                                                                     ”‚


    // ”‚  1. YOUR BACKEND creates an ABA PayWay transaction:                 ”‚


    // ”‚     POST https://checkout.payway.com.kh/api/payment-gateway/v1/    ”‚


    // ”‚          payments/purchase                                          ”‚


    // ”‚     Headers: { Authorization: 'Bearer <ABA_API_KEY>' }             ”‚


    // ”‚     Body: {                                                         ”‚


    // ”‚       tran_id:   'EVT-<eventId>-<timestamp>',  // your unique ID   ”‚
    ...
    // ”‚       items:     [{ name: eventTitle, quantity: 1, price: 5.00 }], ”‚


    // ”‚       return_url: 'https://yoursite.com/payment/return',            ”‚


    // ”‚       continue_success_url: 'https://yoursite.com/events',          ”‚
    ...
    // ”‚     ’ ABA returns: { tran_id, qr_code (base64 PNG), status }       ”‚


    // ”‚                                                                     ”‚


    // ”‚  2. FRONTEND displays qr_code image directly (no library needed)   ”‚
    ...
    // ”‚  3. USER scans QR with ABA Mobile app ’ confirms payment           ”‚


    // ”‚                                                                     ”‚


    // ”‚  4. ABA sends a WEBHOOK to your backend:                            ”‚


    // ”‚     POST /api/payments/aba-webhook/                                 ”‚


    // ”‚     Body: { tran_id, status: 'SUCCESS', amount, hash }              ”‚


    // ”‚     ’ verify hash with SHA512-HMAC using your ABA_MERCHANT_SECRET  ”‚
    ...
    // ”‚  5. FRONTEND polls every 3 s:                                       ”‚


    // ”‚     GET /api/payments/status/{tran_id}/                             ”‚


    // ”‚     ’ { status: 'pending'|'paid'|'failed' }                        ”‚


    // ”‚     ’ when 'paid': auto-approve ticket, close modal                ”‚
    ...
    // ”‚    def aba_webhook(request):                                        ”‚


    // ”‚        data = json.loads(request.body)                              ”‚


    // ”‚        expected = hmac.new(ABA_SECRET, msg, sha512).hexdigest()     ”‚


    // ”‚        if expected != data['hash']: return 403                      ”‚


    // ”‚        PaymentRecord.objects.filter(                                ”‚


    // ”‚            tran_id=data['tran_id']).update(status='paid')           ”‚
    ...
    // ”‚  That is the full loop. The webhook updates the DB, the poll       ”‚


    // ”‚  detects the change ’ page auto-completes with no user action.     ”‚
  ...
  if (isLoading) {
    ...
    return (
      ...
      <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white">
        ...
        <p className="text-sm font-medium text-gray-400 tracking-wide">Loading events…</p>
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Create Event button disabled for MVP */}
      ...
      {/* Create Event Modal - Removed for MVP */}
...
// Create Event Modal ” React.memo + internal Section 7 multi-step flow


// Steps (per flowchart.md §7): form ’ venue_fee ’ fee_payment (if yes) ’ ai_eval ’ submitted


const CreateEventModal = React.memo(({ eventForm, handleFormChange, handlePdfUpload, removePdf, calculatePlatformFee, handleCreateEventSubmit, setShowCreateEventModal, setEventForm }) => {
  ...
  // ”” Section 7 local state ””””””””””””””””””””””””””””””””””””””””””””””””


  const [step, setStep] = React.useState('form')


  const [ticketPaymentProof, setTicketPaymentProof] = React.useState(null)


  const [ticketPaymentProofPreview, setTicketPaymentProofPreview] = React.useState(null)


  const [ticketPaymentStep, setTicketPaymentStep] = React.useState('review')


  const [ticketPaymentRejectionReason, setTicketPaymentRejectionReason] = React.useState('')
  ...
  const STEPS = ['Event Details', 'Ticket Payment', 'AI Evaluation', 'Submit']


  const stepIndex = { form: 0, ticket_payment: 1, ai_eval: 2, submitted: 3 }
  ...
  const handleTicketPaymentProofUpload = (e) => {
    ...
    reader.onload = (ev) => {
      ...
      setTicketPaymentProofPreview(ev.target.result)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {step === 'form' && (
          ...
          <>
            ...
            <div className="p-6 border-t border-gray-200 flex items-center justify-between">
              ...
              <span className="text-sm">{platformFee > 0 ? <span className="text-red-600 font-medium">Platform fee: ${platformFee.toFixed(2)}</span> : <span className="text-green-600 font-medium">Free event ” no platform fee</span>}</span>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button onClick={() => setStep('ticket_payment')} className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 font-medium transition-all">
              ...
              <div className="flex items-center justify-center h-full">
                ...
                <div className="text-center max-w-md">
                  ...
                  <button
                    ...
                    onClick={() => { setStep('ai_eval'); triggerAiEval() }}
        ...
        {step === 'venue_fee' && (
          ...
          <div className="p-8 overflow-y-auto flex-1 flex flex-col items-center justify-center">
            ...
            <div className="max-w-lg w-full text-center">
              ...
              <button onClick={() => setStep('ticket_payment')} className="text-sm text-gray-400 hover:text-gray-600 transition-colors"> Back to Event Details</button>
        ...
        {/* ”” STEP 2b: Fee Payment (upload ’ verifying ’ rejected/approved) ”” */}
          ...
          <div className="p-6 overflow-y-auto flex-1">
              ...
              <div className="max-w-md mx-auto">
                ...
                <label className={`block border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-all ${venueFeeProofPreview ? 'border-green-400 bg-green-50' : 'border-gray-300 bg-gray-50 hover:border-purple-400 hover:bg-purple-50'}`}>
                  ...
                  {venueFeeProofPreview
                    ...
                    : <><ArrowUpTrayIcon className="w-12 h-12 text-gray-400 mx-auto mb-3" /><p className="text-sm font-medium text-gray-700">Click to upload payment receipt</p><p className="text-xs text-gray-400 mt-1">Image or PDF · max 5 MB</p></>
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button onClick={() => setStep('venue_fee')} className="flex-1 px-4 py-3 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg font-medium transition-all"> Back</button>


                  <button onClick={() => { if (!venueFeeProof) return; setVenueFeePayStep('verifying') }} className="flex-1 px-4 py-3 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-medium transition-all">Submit for Verification ’</button>
            ...
            {venueFeePayStep === 'verifying' && (
              ...
              <div className="max-w-md mx-auto text-center">
                ...
                <p className="text-sm text-gray-500 mb-6">Your payment proof is being reviewed (1“3 business days).</p>
                ...
                <p className="text-xs text-gray-400 mb-3">” DEMO: Simulate finance decision ”</p>


                <div className="flex gap-3">


                  <button onClick={() => { setVenueFeeRejectionReason('Amount on receipt does not match the quoted rental fee.'); setVenueFeePayStep('rejected') }} className="flex-1 px-4 py-2 bg-red-100 text-red-700 hover:bg-red-200 rounded-lg text-sm font-medium transition-all">— Reject</button>


                  <button onClick={() => setVenueFeePayStep('approved')} className="flex-1 px-4 py-2 bg-green-100 text-green-700 hover:bg-green-200 rounded-lg text-sm font-medium transition-all">“ Approve</button>
            ...
            {venueFeePayStep === 'rejected' && (
              ...
              <div className="max-w-md mx-auto">
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-5 mb-4">
                  ...
                  <div className="flex items-center gap-3 mb-3"><div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0"><span className="text-red-600 text-lg">—</span></div><h4 className="font-bold text-red-800">Payment Proof Rejected</h4></div>
                ...
                <button onClick={() => { setVenueFeeProof(null); setVenueFeeProofPreview(null); setVenueFeePayStep('upload') }} className="w-full px-4 py-3 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-medium transition-all">Re-upload Proof ’</button>
            ...
            {venueFeePayStep === 'approved' && (
              ...
              <div className="max-w-md mx-auto text-center">
                ...
                <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', stiffness: 250, damping: 20 }}
                  ...
                  className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4"><span className="text-4xl"></span></motion.div>
                ...
                <button onClick={() => { setStep('ai_eval'); triggerAiEval() }} className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-lg font-medium transition-all">Proceed to AI Evaluation ’</button>
          ...
          <div className="p-8 overflow-y-auto flex-1 flex flex-col items-center justify-center">
            ...
            <div className="max-w-md w-full">
              ...
              <div className="text-center mb-6">
                ...
                <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-3"><span className="text-3xl"></span></div>
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    ...
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 transition-all duration-500 ${i < aiEvalProgress ? 'bg-green-100' : 'bg-gray-100'}`}>
                      ...
                      {i < aiEvalProgress ? <span className="text-green-600 text-xs font-bold">“</span> : i === aiEvalProgress ? <div className="w-3 h-3 bg-indigo-500 rounded-full animate-pulse" /> : <div className="w-3 h-3 bg-gray-300 rounded-full" />}
              ...
              {aiEvalDone ? (
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4 text-center text-sm text-green-700 font-medium"> All checks passed ” your event is ready for submission!</div>
        ...
        {/* ”” STEP 4: Submitted ” Three Simultaneous Outcomes ”” */}
        ...
        {step === 'submitted' && (
          ...
          <div className="p-8 overflow-y-auto flex-1">
            ...
            <div className="text-center">
              ...
              <button onClick={closeModal} className="px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-semibold transition-all">View Events ’</button>
