...
const OrganizerClubCard = ({ club, setSelectedOrganizerClub, setShowOrganizerClubDetailModal, viewClubMembers, openImageUploadModal }) => {
...
export default OrganizerClubCard
