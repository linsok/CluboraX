...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Campus Event and Club Management API',
    'DESCRIPTION': 'API documentation for Campus Event and Club Management System',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@campus.edu')
...
IMAGE_UPLOAD_TYPES = ['image/jpeg', 'image/png', 'image/gif', 'image/webp']
MAX_IMAGE_SIZE = 5 * 1024 * 1024  # 5MB

# QR Code Settings
QR_CODE_EXPIRY_HOURS = config('QR_CODE_EXPIRY_HOURS', default=2, cast=int)
...
AI_CHAT_DISTANCE_HIGH_CONF = config('AI_CHAT_DISTANCE_HIGH_CONF', default=0.55, cast=float)
AI_CHAT_DISTANCE_MED_CONF = config('AI_CHAT_DISTANCE_MED_CONF', default=0.75, cast=float)
